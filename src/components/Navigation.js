...
const StyledHover = styled.div`
  ...
  transform: ${props =>
    props.location.pathname.includes("projects") && "translateX(4px)"};
  transform: ${props =>
    props.location.pathname.includes("about") && "translateX(129px)"};
  transform: ${props =>
    props.location.pathname.includes("blog") && "translateX(233px)"};
  top: 50px;
